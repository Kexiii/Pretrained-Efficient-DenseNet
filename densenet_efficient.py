...
class DenseNetEfficient(nn.Module):
    ...
    def __init__(self, growth_rate=12, block_config=(16, 16, 16), compression=0.5,
        ...
        for i, num_layers in enumerate(block_config):
            ...
            self._channels['denseblock%d' % (i + 1)] = num_features
        ...
        self._out_channels = num_features
...
def densenet121(avgpool_size = 7):
    return DenseNetEfficient(growth_rate=32, block_config=(6,12,24,16), compression=0.5,
                 num_init_features=64, bn_size=4, drop_rate=0,
                 num_classes=1000,avgpool_size = avgpool_size)
    
def densenet169(avgpool_size = 7):
    model = DenseNetEfficient(growth_rate=32, block_config=(6,12,32,32), compression=0.5,
                 num_init_features=64, bn_size=4, drop_rate=0,
                 num_classes=1000,avgpool_size = avgpool_size)
